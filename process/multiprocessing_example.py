...
# to prevent accidentially lauch multi processing
if __name__ == '__main__':
    ...
    # make main process wait until sup process done
    # unless main process will end and nothing left to sub-completion
